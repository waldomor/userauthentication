...
if (isset($_POST["sub"])) {
  ...
  $emailErr = "Invalid email format";
      ...
      if ($result > 0) {
        ...
        $msgType = "warning";
        //echo 'And my error is: ' . $e->getMessage();ALTER TABLE `users` AUTO_INCREMENT = 1
      }
    }
  } catch (Exception $ex) {
    echo $ex->getMessage();
...
<br>
<br>
<h3 class="text-center">SITE UNDER MAINTENANCE ⚠</h3><center>
<a href="https://icon-library.net/icon/maintenance-icon-vector-16.html" ><img src="https://icon-library.net//images/maintenance-icon-vector/maintenance-icon-vector-16.jpg" width="350" /></a><br>
<br>
...
<!--style="position:relative;left:489px;   position:relative;left:430px     display: flex;  align-items: center; !important;-->
            <!--/div>
          </fieldset>  </center>
          <br>          <br>
